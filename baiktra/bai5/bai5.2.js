...
console.log(Nam.className);
console.log(Nam.getFullName());
console.log(Hoa.className);
console.log(Hoa.getFullName());
console.log(Mai.className);
console.log(Mai.getFullName());
console.log(Dung.className);
console.log(Dung.getFullName());
console.log(Hanh.className);
